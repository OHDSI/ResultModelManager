test_that("Grant permissions", {
  ...
  expect_error(
    grantTablePermissions(connectionDetails = connectionDetails,
  ...
  DatabaseConnector::renderTranslateExecuteSql(connection = testDatabaseConnection,
                                               sql = sql,
                                               database_schema = testSchema,
                                               table_prefix = "test_utils_")

  # Not crashing is the test here
  grantTablePermissions(connection = testDatabaseConnection,
                        tableSpecification = tableSpecification,
  ...
  grantTablePermissions(connectionDetails = testDatabaseConnectionDetails,
                        tableSpecification = tableSpecification,
                        databaseSchema = testSchema,
                        tablePrefix = "test_utils_",
                        permissions = "DELETE",
