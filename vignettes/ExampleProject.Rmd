...
| namespace | table_name           | column_name           | data_type | primary_key | optional |
|-----------|----------------------|-----------------------|-----------|-------------|----------|
...
Results exported from this package are covariate prevalences related to a cohorts and given a covariate_id, these are
related to names in a second table.

The recommended format is a namespaced YAML file saved to the `inst` folder of your R package.
...
```{r,eval=FALSE}
specification <- ResultModelManager::loadResultsDataModelSpecifications("resultsDataModelSpecification.yaml")
```
